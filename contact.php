            ...
            <div class="content-wrapper">
                ...
                <div class="contact-widget">
                    <div class="icon-box">
                        ...
                        <div class="text">Pune <br> Maharashtra, India 4110.</div>
                    </div>
                    <div class="icon-box">
                        <div class="icon"><span class="flaticon-calling"></span></div>
                        <div class="text"><strong>Phone</strong><a href="tel:(+91)9503369790"><?php $setting['map']; ?></a></div>
                    </div>
                    <div class="icon-box">
                        <div class="icon"><span class="flaticon-mail"></span></div>
                        <div class="text"><strong>Email</strong><a href="tel:(+91)9405001913">supportyou@transida.com</a></div>
                    </div>
                </div>
                <!-- Link Btn -->
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="icon-box">
                                            <div class="icon"><span class="flaticon-mail"></span></div>
                                            <div class="text-area">
                                                <div class="text"><strong>Mon - Friday</strong>09.00 am to 9.00pm</div>
